...
c'est à dire que comme dans nombreux langages, (java par exemple)
Il va nous falloir indiquer le type de nos variable et arguments.
*/
...
/*
   Si une variable peut contenir n'importe quel type de donnée, on ourra utiliser le mot clef "any".
...
Je vais devoir indiquer chaque propiété et chaque valeur :
...
*/
const person2:{prenom:string, [key:string]:string} = {prenom:"Oracle",nom:"Dupont"}
/*
j'indique ici que les possibles propiétés (key) supplémentaires de mon objet seront des string contenant comme valeur, des string.

Dans le cas d'une instanciation de classe, on peut simplement utiliser le nom de la classe.
 */

const today: Date = new Date()
// Bien que plus rarement utilisé,si on veux mettre une fonction dans une variable, il faudra aussi l'indiquer : 
...
//document.addEventListener("pointer",clickMe)
/*
...
//btn1?.getElementsByClassName.color = "red"
/*
...
/*
 Avec cette première méthode, on précise gràce à "as" quel sera le type retourné.
 Il existe d'autres façon de l'écrire : 
*/
const btn2 = <HTMLButtonElement>document.querySelector("#compte") 
// au dessus, le resulat sera le même que "as"
const btn3 = document.querySelector("#compte")!
// Au dessus, le "!" permet de faire oublier la possiblité "null"
