...
/*
   ...
   TS l'a ien compris et permet de créer nos propres types ou collection de type.
*/
...
/*
 Ici notre type "Full" n'accepte frace à "keyof"
 que des string qui sont égale aux noms des propriété de "Person"
*/
let fp: Full = "age"
fp = "nom"
...
/*
 Sur ce dernier exemple, le type est crée par rappor à l'objet précédement déclaré.
...
/*
  ...
  Dans notre second cas, on lui indique qu'elle va recevoir un type particculier, elle ne sait pas lequel mais il est sauvegardé, et on lui indique ensuite qu'elle retournera ce même type.
...
/*
 Ici on indique que notre argument est un tableau d'un type précis Mais que le retour n'est pas un tableau, seulement le type qui était contenu dans le tableau. (ou undefined)
*/
