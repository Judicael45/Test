...
/*
  Par défaut typescript compile pour du JS un peu âgé, faisant disparaitre let, const et fonction fléché pour les remplacer par des var et des fonctions anonymes.
  On peut ajouter à notre fichier de configuration l'option suivante : 
  * "target" : "ES2022"
  Pour indiquer vers quel version de Ecmascrpit la compilation doit se faire .
  ...
  *"noEmitOnError" : true
  ...
  Et si on veux un code capable de gérer n'importe quel erreur , on peut demander à TS d'être bien plus strict sur sa détection avec l'option : 
  * "strict" : true
