...
const r2 = /[ou]/;
// La méthode test() s'applique sur une regex et prend un string en argument. Elle se retournera true ou false selon si la regex correspond ou non.
...
// Recherche les caractères entre a et z compris.
const r6 = /[a-z]/
console.log(r6, r6.test("Bonjour"), r6.test("06302945"));
// Recherche si le string ne contient pas ces caractères.
const r7 = /[^a-z]/
console.log(r7, r7.test("bonjour"), r7.test("06302945"));
...
/// Recherche la présence de "ou" dont "u" apparait deux fois d'affilé.
const r12 = /(ou){2}/
...
// Recherche de la présence de "ou" deux fois ou plus.
const r14 = /(ou){2,}/
...
// "\1" recherche le même résultat que la première parenthèse.
//(Et ainsi de suite avec \2, \3...)
const r18 = /(ou|oi).*\1/
console.log(r18, r18.test("Coucou"), r18.test("Bonsoir 8 fois"))

//------------------Match-------------------
const phrase = "J'aime la pizza, les cannelés et les okonomiyakis"
// Match est une méthode de string qui retourne un tableau correspondant au éléments retrouvé par ma ragex.
// Match prend en argument, un regex ou un strng à rechercher.
console.log(phrase.match(/pizza/));
// par défaut, match s'arrête au premier élément retrouvé.
console.log(phrase.match(/les/));
// le flag g pour gobal permet de ne pas s'arrêter au premier résultat mais de fouiller le string en entier.
console.log(phrase.match(/les/g));
// Avec le flag "i", la regex devient insensible à la casse(mnuscule ou majuscule)
...
console.log(/^[a-zéèâäë]+$/.test("élodie"));
