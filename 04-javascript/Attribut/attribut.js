...
Vous pouvez pas récupérer ainsi, le style du fichier css,seulement celui inline.
*/
...
// si il y'a une erreur sur le nom de la propriété ou sur sa valeur, JS ne provoque pas d'erreur.
//  il ne se passe juste rien.
...
//----------Les classes----------
// lattribut classList permet de récupérer un tableau contenant toute les classes de l'élément.
...
// .contains permet de vérifir la présence ou non d'une classe.
...
// Mais on peut aussi y accéder avec getAttribut et setAttribute

console.log(h1.getAttribute("id"));

//setAttribute prend en premier paramètre l'attribut que je souhaite modifier,
//et en second la valeur que je veux lui donner.
...
// nommer comme on le souhaite.

a.dataset.color="pink"
a.dataset.bidule = "Nouveau data-attribut"

//On utlise dataset pour accèder aux data-attributes suivi du nom de ce data-attr 
//(pour en créer un nouveau il suffi de mettre un nom qui n'existe pas)
